export const projets = [
  ...
  },
  {
    ...
    descriptionlongue:
      "Projet perso d'application cli de chiffrement et de dechiffrement de fichier en python et en utilisant la biblioteque cryptography",
  ...
  },
  {
    ...
    descriptionlongue:
      "Découverte du framework VueJS, comprenant l'utilisation du routage pour la gestion des vues, la connexion à un webhook, ainsi que l'affichage et l'utilisation d'une API.",
  ...
  },
  {
    ...
    team: 'Valentin Fiess',
    description:
      "Découverte de PHP Symfony à travers la création d'une bibliothèque musicale intégrant des fonctionnalités CRUD et une base de données",
    descriptionlongue:
      "Découverte de PHP Symfony à travers la gestion d'un projet, en solo, de création d'une bibliothèque musicale intégrant des fonctionnalités CRUD, une authentification de compte, une API REST, des tests unitaires et une base de données.",
  ...
  },
  {
    ...
    description:
      "Projet de création d'entreprise fictive de mise en relation entre étudiant et professionnel avec fonctionnalité de swipe en PHP, HTML et CSS ",
    descriptionlongue:
      "Projet de création d'une entreprise fictive de mise en relation entre étudiants et professionnels, avec fonctionnalité de swipe en PHP, HTML et CSS. Nous avons également utilisé des techniques de gestion de projet telles que Kanban avec Trello.",
  ...
  },
  {
    ...
    team: 'Groupe de classe',
    description:
      " Création d'un projet complet avec site web, MCD, SEO, Emailing et SMO développé en HTML, CSS, JavaScript et PHP",
    descriptionlongue:
      " Création d'un projet complet a plusieurs avec site web, MCD, SEO, Emailing et SMO développé en HTML, CSS, JavaScript et PHP",
  ...
  },
  {
    ...
    team: 'Groupe de classe',
    description:
      "Refonte d'un site web d'hotel avec base de données intégrée, développé en HTML, CSS, JavaScript, PHP et MySQL",
    descriptionlongue:
      "Refonte d'un site web d'hotel avec gestion de base de données MySQL, développé en HTML, CSS, JavaScript et PHP.",
