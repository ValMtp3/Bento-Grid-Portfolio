...
<template>
  <div class="text-coffee-bean-800">
    <div class="container mx-auto p-6">
      <h1 class="text-3xl font-bold font-heading mb-6 text-center">Mentions Légales</h1>

      <section class="mb-10">
        <h2 class="text-2xl font-semibold font-heading mb-2">Identité du propriétaire du site</h2>
        <div class="bg-soft-blush-50 p-4 shadow rounded-lg">
      ...
      <section class="mb-10">
        <h2 class="text-2xl font-semibold font-heading mb-2">Responsable de la publication</h2>
        <div class="bg-soft-blush-50 p-4 shadow rounded-lg">
      ...
      <section class="mb-10">
        <h2 class="text-2xl font-semibold font-heading mb-2">Hébergeur du site</h2>
        <div class="bg-soft-blush-50 p-4 shadow rounded-lg">
      ...
      <h1 class="text-3xl font-bold font-heading mb-6 text-center">
        Conditions Générales d'Utilisation (CGU)
      </h1>

      <section class="mb-10">
        <h2 class="text-2xl font-semibold font-heading mb-2">Objet des CGU</h2>
        <div class="bg-soft-blush-50 p-4 shadow rounded-lg">
          <p>
      ...
      <section class="mb-10">
        <h2 class="text-2xl font-semibold font-heading mb-2">Accès au site</h2>
        <div class="bg-soft-blush-50 p-4 shadow rounded-lg">
      ...
      <section class="mb-10">
        <h2 class="text-2xl font-semibold font-heading mb-2">Propriété intellectuelle</h2>
        <div class="bg-soft-blush-50 p-4 shadow rounded-lg">
          <p>
      ...
      <section class="mb-10">
        <h2 class="text-2xl font-semibold font-heading mb-2">Modifications des CGU</h2>
        <div class="bg-soft-blush-50 p-4 shadow rounded-lg">
          <p>
      ...
      <h1 class="text-3xl font-bold font-heading mb-6 text-center">Autres informations</h1>

      <section class="mb-10">
        <h2 class="text-2xl font-semibold font-heading mb-2">Litiges et droit applicable</h2>
        <div class="bg-soft-blush-50 p-4 shadow rounded-lg">
          <p>
