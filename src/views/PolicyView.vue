      ...
      <section class="mb-10">
        ...
        <div class="bg-white dark:bg-coffee-bean-900/60 dark:border dark:border-coffee-bean-800/40 p-4 shadow rounded-lg">
          <p>
            ...
            et protégées lors de votre visite. Je m'engage à respecter votre vie privée et à
            protéger les informations personnelles que vous partagez.
          </p>
        </div>
      </section>
      ...
      <section class="mb-10">
        ...
        <div class="bg-white dark:bg-coffee-bean-900/60 dark:border dark:border-coffee-bean-800/40 p-4 shadow rounded-lg">
          <p>
            ...
            pour une durée indéfinie. Cette conservation indéterminée est justifiée par la nécessité
      ...
      <section class="mb-10">
        ...
        <div class="bg-white dark:bg-coffee-bean-900/60 dark:border dark:border-coffee-bean-800/40 p-4 shadow rounded-lg">
          <p>
            ...
            sont soumises aux sécurités offertes par les services de messagerie utilisés.
          </p>
        </div>
      </section>
