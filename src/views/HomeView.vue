...
<template>
  ...
  <div class="px-4 py-2">
    <div class="flex flex-col xl:flex-row xl:justify-around space-y-4 xl:space-x-4">
      <div
        class="bg-white dark:bg-dark-card font-[AnonymousPro] p-1 rounded-3xl w-full max-w-none transition-colors duration-300"
      >
        <span
          class="text-base sm:text-xl underline my-2 flex justify-center text-center text-neutral-900 dark:text-dark-primary"
          >Maitrise</span
        >
        <div class="grid grid-cols-4 gap-12 m-2 justify-items-center items-center h-full">
          ...
          <span class="dark:text-dark-primary"> À venir ...</span>
        </div>
      </div>
      <div
        class="bg-white dark:bg-dark-card font-[AnonymousPro] p-1 rounded-3xl w-full max-w-none transition-colors duration-300"
      >
        ...
        <div class="grid grid-cols-2 mr-12 m-2 justify-items-center items-center h-full">
          ...
          />
          <button
            class="text-3xl font-bold m-20 col-span-2 cursor-pointer text-neutral-900 dark:text-dark-primary hover:opacity-80 transition-opacity duration-200"
  ...
  <div class="px-4 py-2">
    <div
      class="bg-white dark:bg-dark-card font-[AnonymousPro] p-4 rounded-3xl w-full max-w-none transition-colors duration-300"
    >
